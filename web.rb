    ...
    when Line::Bot::Event::Message
      ...
      when Line::Bot::Event::MessageType::Text
        message = case event.message['text']
                  ...
                  when /李老闆/
                    {
                      text: ['去後面罰站!', '不要怕，我後台很硬!', '朋友只是個過程，我們在一起吧(　^ω^)', '這裡的馬鈴薯燉肉很好吃!', '我要去北投泡溫泉', '好了，你可以回來了'].sample,
                      type: 'text'
                    }
...
BOSS_SAY = %w(好秀嗎？ wu你妹 億全 愛溝共 小組抱抱 西咧靠腰 衝啥 亞榆勒 大家好!我叫陳囧).freeze
BULLETS = %w(翻譯翻譯 黃四郎臉上有四嗎？
